...
import { getIndiaAction } from "../../../../redux/actions/getMahaAction";
...
const TotalUsers = props => {
  ...
  const indiaSelector = useSelector((state) => state.GetIndia);
  const dispatch = useDispatch();
  const getIndiaAction2 = () => dispatch(getIndiaAction());
  const { state, active, confirmed, deaths, recovered, statecode } = indiaSelector.ind;
